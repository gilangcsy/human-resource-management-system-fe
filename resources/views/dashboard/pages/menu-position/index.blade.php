                            ...
                            <div class="dd" id="nestable">
                                <ol class="dd-list">
                                    @foreach ($lists as $list)
                                        @if ($list['childs'])
                                            <li class="dd-item" data-id="{{ $list['id'] }}" data-menu="{{$list['name']}}" data-position="{{ $list['position'] }}">
                                                <div class="dd-handle">
                                                    {{ $list['name'] }}
                                                </div>
                                                <ol class="dd-list">
                                                    @foreach ($list['childs'] as $child)
                                                        <li class="dd-item" data-id="{{ $child['id'] }}" data-menu="{{$child['name']}}" data-position="{{ $child['position'] }}">
                                                            <div class="dd-handle">
                                                                {{ $child['name'] }}
                                                            </div>
                                                        </li>
