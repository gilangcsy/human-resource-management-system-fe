                            ...
                            <tbody>
                                @foreach ($claims as $item)
                                    <tr>
                                        ...
                                        <td>{{$item->start_date != null ? \Carbon\carbon::parse(strtotime($item->start_date))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d') : 'N/A'}}</td>
                                        <td>{{$item->end_date != null ? \Carbon\carbon::parse(strtotime($item->end_date))->setTimezone('Asia/Jakarta')->translatedFormat('Y-m-d') : 'N/A'}}</td>
