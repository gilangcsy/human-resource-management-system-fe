        ...
        <div class="content ">
                ...
                <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
                    <div class="inner">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $leaveType->id != '' ? 'Edit' : 'Create' }}</li>
                        </ol>
                        <!-- END BREADCRUMB -->
                    </div>
                </div>
            ...
            <div class="container-fluid container-fixed-lg">
                ...
                <div class="card card-default">
                    <div class="card-body">
                        <form method="POST" action="{{ $leaveType->id == '' ? route('leave-type.store') : route('leave-type.update', $leaveType->id) }}">
                            @csrf
                            @if ($leaveType->id != '')
                                @method('patch')
                            @endif
                            <div class="form-group form-group-default required">
                                <label>Name</label>
                                <input type="text" value="{{ old('name', $leaveType->name) }}" name="name" class="form-control" required>
                            </div>
