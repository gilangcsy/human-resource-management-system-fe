        ...
        <div class="content ">
                ...
                <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
                    <div class="inner">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $claimType->id != '' ? 'Edit' : 'Create' }}</li>
                        </ol>
                        <!-- END BREADCRUMB -->
                    </div>
                </div>
            ...
            <div class="container-fluid container-fixed-lg">
                ...
                <div class="card card-default">
                    <div class="card-body">
                        <form method="POST" action="{{ $claimType->id == '' ? route('claim-type.store') : route('claim-type.update', $claimType->id) }}">
                            @csrf
                            @if ($claimType->id != '')
                                @method('patch')
                            @endif
                            <div class="form-group form-group-default required">
                                <label>Name</label>
                                <input type="text" value="{{ old('name', $claimType->name) }}" name="name" class="form-control" required>
                            </div>
                            
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary">
                                    {{ $claimType->id != '' ? 'Update' : 'Save' }}
                                </button>
