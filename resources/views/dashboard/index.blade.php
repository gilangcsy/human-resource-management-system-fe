                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-6">
                                            ...
                                            <div class="row m-t-20 timeslot">
                                                <div class="col-lg-12">
                                                    <a href="{{ $attendanceStatus == 'Clock In' ? route('attendance.create') : route('attendance.edit', $attendanceData->id) }}" class="btn {{ $attendanceStatus == 'Clock In' ? 'btn-complete' : 'btn-danger'}} {{ $attendanceStatus == 'Already Recorded' ? 'd-none' : ''}}">{{ $attendanceStatus == 'Clock In' ? 'New Attendance' : $attendanceStatus}}</a>
                                                </div>
                                            </div>
                                        </div>
