                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group text-center">
                                        <img alt="clock in selfie" width="200" src="<?php echo e($attendanceData->clockInPhoto == '' ? asset('assets/img/profiles/default.jpg') : $url_storage . 'storage/attachment/attendances/clockIn/' . $attendanceData->clockInPhoto); ?>" width="350" height="350" class=" mr-1 img-thumbnail img-fluid">
                                    </div>
                                    ...
                                    <div class="form-group text-center">
                                        <img alt="clock out selfie" width="200" src="<?php echo e($attendanceData->clockOutPhoto == '' ? asset('assets/img/profiles/default.jpg') : $url_storage . 'storage/attachment/attendances/clockOut/' . $attendanceData->clockOutPhoto); ?>" width="350" height="350" class=" mr-1 img-thumbnail img-fluid">
                                    </div>
                                    ...
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Select Type" id="workLoadStatus" name="workLoadStatus"
                                            ...
                                            <option value="Moderate"
                                                <?php echo e($attendanceData->workLoadStatus == 'Moderate' ? 'selected' : ''); ?>>
                                                Moderate
                                            </option>
                                            <option value="Busy"
                                                <?php echo e($attendanceData->workLoadStatus == 'Busy' ? 'selected' : ''); ?>>
                                                Busy
                                            </option>
                                        </select>
                                    </div>
...
<?php echo $__env->make('dashboard.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\IDS\human-resource-management-system-fe\resources\views/dashboard/pages/my-attendance/form.blade.php ENDPATH**/ ?>