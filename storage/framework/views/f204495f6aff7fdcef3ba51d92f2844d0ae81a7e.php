                ...
                <div class="card card-transparent">
                    <div class="card-header">
                        <div class="card-title">
                            <form action="<?php echo e(route('claim-type.create')); ?>">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-striped" id="tableWithSearch">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $claimTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($loop->iteration); ?></td>
                                        <td><?php echo e($item->name); ?></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="<?php echo e(route('claim-type.edit', $item->id)); ?>" class="btn btn-warning">
                                                    <i class="pg-icon">edit</i>
                                                </a>
    
                                                <form action="<?php echo e(route('claim-type.destroy', $item->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\SKRIPSI\App\human-resource-management-system-fe\resources\views/dashboard/pages/claim-type/index.blade.php ENDPATH**/ ?>