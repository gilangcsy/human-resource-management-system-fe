...
<?php $__env->startSection('title', 'Leave Detail'); ?>
                    ...
                    <div class="card-body">
                        <table class="table table-striped" id="tableWithSearch">
                            ...
                            <tbody>
                                ...
                                <?php endif; ?>
                                <?php if($leave->approver_three != null): ?>
                                    <tr>
                                        <td>3</td>
...
<?php echo $__env->make('dashboard.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\SKRIPSI\App\human-resource-management-system-fe\resources\views/dashboard/pages/leave/detail.blade.php ENDPATH**/ ?>