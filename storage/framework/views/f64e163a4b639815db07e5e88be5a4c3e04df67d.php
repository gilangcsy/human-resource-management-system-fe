...
<?php $__env->startSection('title', 'Claim Type'); ?>
        ...
        <div class="content ">
                ...
                <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
                    <div class="inner">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/claim-type">Claim Type</a></li>
                            <li class="breadcrumb-item active"><?php echo e($claimType->id != '' ? 'Edit' : 'Create'); ?></li>
                        </ol>
                        <!-- END BREADCRUMB -->
                    </div>
                </div>
            ...
            <div class="container-fluid container-fixed-lg">
                ...
                <div class="card card-default">
                    <div class="card-body">
                        <form method="POST" action="<?php echo e($claimType->id == '' ? route('claim-type.store') : route('claim-type.update', $claimType->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <?php if($claimType->id != ''): ?>
                            ...
                            <div class="form-group form-group-default required">
                                <label>Name</label>
                                <input type="text" value="<?php echo e(old('name', $claimType->name)); ?>" name="name" class="form-control" required>
                            </div>
                            
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary">
                                    <?php echo e($claimType->id != '' ? 'Update' : 'Save'); ?>
...
<?php echo $__env->make('dashboard.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\SKRIPSI\App\human-resource-management-system-fe\resources\views/dashboard/pages/claim-type/form.blade.php ENDPATH**/ ?>