    ...
    <div class="overlay hide" data-pages="search">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                <!-- BEGIN Overlay Logo !-->
                <img class="overlay-brand" src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="logo" data-src="<?php echo e(asset('assets/img/logo.png')); ?>"
                            ...
                            <div class="d-flex m-t-15">
                                ...
                                <div class="thumbnail-wrapper d48 circular bg-success text-white ">
                                    <img width="36" height="36" src="assets/img/profiles/avatar.jpg"
                                        data-src="<?php echo e(asset('assets/img/profiles/avatar.jpg')); ?>"
                                        data-src-retina="<?php echo e(asset('assets/img/profiles/avatar2x.jpg')); ?>" alt="">
                                </div>
...
<?php /**PATH D:\Work\IDS\human-resource-management-system-fe\resources\views/dashboard/partials/app.blade.php ENDPATH**/ ?>