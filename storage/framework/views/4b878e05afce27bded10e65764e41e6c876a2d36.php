                        ...
                        <table class="table table-striped" id="tableWithSearch">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($item->User->employee_id); ?></td>
                                    <td><?php echo e($item->User->full_name); ?></td>
                                    <td><?php echo e(\Carbon\carbon::parse(strtotime($item->clockIn))->setTimezone('Asia/Jakarta')->translatedFormat('d M Y - H:i')); ?></td>
                                    <td><?php echo e($item->clockOut != null ? \Carbon\carbon::parse(strtotime($item->clockOut))->setTimezone('Asia/Jakarta')->translatedFormat('d M Y - H:i') : 'N/A'); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('attendance.edit', $item->id)); ?>" class="btn btn-warning">
...
<?php echo $__env->make('dashboard.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\SKRIPSI\App\human-resource-management-system-fe\resources\views/dashboard/pages/my-attendance/index.blade.php ENDPATH**/ ?>