                        ...
                        <form method="POST" action="<?php echo e($role->id == '' ? route('role.store') : route('role.update', $role->id)); ?>">
                            ...
                            <div class="form-group form-group-default form-group-default-select2 required">
                                ...
                                <select class="full-width" name="superior_id" data-init-plugin="select2">
                                    <option value="" <?php echo e(old('superior_id', $role->superior_id) == null || old('superior_id', $role->superior_id) == '' ? 'selected' : ''); ?>>--None--</option>
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($item->id != $role->id): ?>
                                            <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == old('superior_id', $role->superior_id) ? 'selected' : ''); ?>><?php echo e($item->name); ?></option>
                                        <?php endif; ?>
...
<?php echo $__env->make('dashboard.partials.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\SKRIPSI\App\human-resource-management-system-fe\resources\views/dashboard/pages/role/form.blade.php ENDPATH**/ ?>