                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e($leave->id == '' ? route('leave.store') : route('leave.update', $leave->id)); ?>" enctype="multipart/form-data">
                            ...
                            <div class="input-daterange input-group" id="datepicker-range">
                                <input type="text" placeholder="From" class="input-sm form-control" name="start_date" value="<?php echo e($leave->start_date != '' ? \Carbon\carbon::parse(strtotime($leave->start_date))->setTimezone('Asia/Jakarta')->translatedFormat('d/m/Y') : ''); ?>" required />
                                <div class="input-group-addon">to</div>
                                <input type="text" placeholder="To" class="input-sm form-control" name="end_date" value="<?php echo e($leave->end_date != '' ? \Carbon\carbon::parse(strtotime($leave->end_date))->setTimezone('Asia/Jakarta')->translatedFormat('d/m/Y') : ''); ?>" required/>
                            </div>
